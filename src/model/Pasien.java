...
public class Pasien extends AntrianPasien{
    ...
    public void setnoRekamMedis(int noRekamMedis) throws Exception{
        if (noRekamMedis < 21 && noRekamMedis > 5) {
                ...
                }else { throw new Exception("nomor rekam medis dibatasi 6 sampai 20");
    ...
    public void setTanggalLahir(int tanggalLahir) throws Exception{
        ...
        }else { throw new Exception("cuma ada tanggal 1 sampai 31"); 
    ...
    public void setBulanLAhir(int BulanLahir) throws Exception{
        ...
        } else { throw new Exception("jumlah bulan hanya 12");      
    ...
    public void settahunLahir(int tahunLahir) throws Exception{
        ...
        }else { throw new Exception("tahun lahir salah"); 
